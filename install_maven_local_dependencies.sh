...
mvn install:install-file -Dfile=src/main/webapp/WEB-INF/lib/yampp-ls.jar -DgroupId=fr.lirmm.yamplusplus -DartifactId=yamppls -Dversion=0.1 -Dpackaging=jar -DgeneratePom=true
