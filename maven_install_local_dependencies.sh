...
mvn install:install-file -Dfile=src/main/webapp/WEB-INF/lib/yampp-ls.jar -DgroupId=fr.lirmm.yamplusplus -DartifactId=yampp-ls -Dversion=0.1.2-SNAPSHOT -Dpackaging=jar -DgeneratePom=true
