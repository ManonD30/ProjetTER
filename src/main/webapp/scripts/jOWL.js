...
jOWL = window.jOWL = function (resource, options) {
  return jOWL.getResource(resource, options);
};
jOWL.version = "1.0";
...
(function ($) {
  ...
  jOWL.NS = function (prefix, URI) {
    ...
    if (arguments.length == 1) {
      ...
      for (var i = 0; i < attr.length; i++) {
        ...
        if (nn.length == 2) {
          if (attr[i].nodeValue == jOWL.NS.owl.URI) {
            jOWL.NS.owl.prefix = nn[1];
          } else if (attr[i].nodeValue == jOWL.NS.rdf.URI) {
            jOWL.NS.rdf.prefix = nn[1];
          } else if (attr[i].nodeValue == jOWL.NS.rdfs.URI) {
            jOWL.NS.rdfs.prefix = nn[1];
          } else if (attr[i].nodeValue == jOWL.NS.xsd.URI) {
            jOWL.NS.xsd.prefix = nn[1];
          } else {
            jOWL.NS(nn[1], attr[i].nodeValue);
          }
        }
      }
  ...
  $.fn.extend({
    ...
    RDF_Resource: function (match) {
      function getClassName(dom) {
        ...
        if (cl.length == 1) {
          return new jOWL.Ontology.Class(cl).URI;
        }
        return false;
      }
      if (!this.length) {
      ...
      if (!rsrc) {
        var dom = this.get(0);
        switch (dom.nodeName) {
          case __.rdfs("subClassOf"):
            rsrc = getClassName(dom);
            break;
          case __.owl("disjointWith"):
            rsrc = getClassName(dom);
            break;
          case __.owl("allValuesFrom"):
            rsrc = getClassName(dom);
            break;
          case __.owl("someValuesFrom"):
            rsrc = getClassName(dom);
            break;
          case __.owl("onProperty"):
            var t = jOWL.Xpath(__.owl("ObjectProperty"), dom);
            if (t.length === 0) {
              t = jOWL.Xpath(__.owl("DatatypeProperty"), dom);
            }
            if (t.length === 0) {
              t = jOWL.Xpath(__.owl("FunctionalProperty"), dom);
            }
            rsrc = t.xmlAttr(__.rdf('about'));
            break;
          default:
            return false;
        }
      ...
      if (match) {
        return rsrc.toLowerCase() == (jOWL.resolveURI(match.toString())).toLowerCase();
      }
      return rsrc;
    },
  ...
  jOWL.Xpath = function (selector, elem) {
    ...
    return $(arr); //this is needed for IE, it returns a length of 1 on empty node array
  };
  ...
  jOWL.priv = {
    ...
    Array: {
      ...
      pushUnique: function (array, item) {
        if (jOWL.priv.Array.getIndex(array, item) === -1) {
          array.push(item);
          return true;
        }
        return false;
  ...
  jOWL.Ontology.Thing.prototype = {
    ...
    description: function () {
      return $.map(this.annotations(__.rdfs('comment')), function (n) {
        return $(n).text();
      });
    },
    /**
    ...
    terms: function () {
      var terms = [], self = this;
      if (jOWL.options.dictionary.addID && this.name != "anonymousOntologyObject") {
        terms.push([this.name.beautify(), this.URI, jOWL.options.defaultlocale, this.type]);
      }
      this.annotations(__.rdfs('label')).each(function () {
        ...
        for (var i = 0; i < terms.length; i++) {
          if (terms[i][0].toUpperCase() == txt.toUpperCase() && terms[i][2] == locale) {
            match = true;
          }
        }
        if (!match) {
          terms.push([lbl.text(), self.URI, locale, self.type]);
        }
      });
      return terms;
    },
  ...
  jOWL.priv.testObjectTarget = function (target, matchtarget) {
    if (target.isArray) {
      for (var i = 0; i < target.length; i++) {
        if (jOWL.priv.testObjectTarget(target.get(i), matchtarget)) {
          return true;
        }
      }
      return false;
    ...
    //if the target is a class, fetch individuals instead.
      ...
      for (var i = 0; i < a.length; i++) {
        if (a.get(i).URI == matchtarget) {
          return true;
        }
      }
    } else if (target.URI == matchtarget) {
      return true;
    }
    return false;
  };
  ...
  jOWL.Ontology.Individual = function (jnode, owlclass) {
    ...
    if (this.type == __.owl("Thing")) {
      ...
      if (!t.length) {
        throw "unable to find a Class for the Individual " + this.name;
      }
  ...
  jOWL.Ontology.Individual.prototype = $.extend({}, jOWL.Ontology.Thing.prototype, {
    ...
    owlClass: function (owlclass) {
      if (owlclass) {
        jOWL.data(this.name, "class", owlclass);
      } else {
    ...
    sourceof: function (property, target, options) {
      ...
      this.jnode.children().filter(function () {
        return (this.prefix != __.rdfs.prefix && this.prefix != __.rdf.prefix && this.prefix != __.owl.prefix);
      })
              .each(function () {
                ...
                if (!propertyMatch) {
                  if (property.isArray) {
                    propertyMatch = property.contains(restriction.property);
                  } else {
                    propertyMatch = (property.URI == restriction.property.URI);
                  }
                  if (!propertyMatch) {
                    return;
                  }
                ...
                if (!target) {
                  ...
                  if (restriction.property.isObjectProperty) {
                    ...
                    targetMatch = (target == restriction.target);
                  }
                }
                if (propertyMatch && targetMatch) {
                  results.pushUnique(restriction);
                }
      ...
      if (options.inherited) {
        var clRestrictions = this.owlClass().sourceof(property, target, options)
                .each(function () {
                  ...
                  var clRestr = this;
                  if (options.valuesOnly && clRestr.target === null) {
                    return;
                  }
                  var clTarget = this.getTarget();
                  if (clTarget.isClass && options.ignoreClasses) {
                    return;
                  }
                  ...
                  for (var i = 0; i < results.length; i++) {
                    ...
                    if (restr.property.URI == clRestr.property.URI) {
                      ...
                      if (!options.ignoreGenerics) {
                        if (clRestr.target != restr.target) {
                          results.pushUnique(clRestr);
                        }
                      }
                    }
                  }
  ...
  jOWL.Ontology.Restriction = function (jnode) {
    ...
    } else
    {
      ...
      prop = jprop.RDF_Resource();
      if (!prop) {
        throw "no property found for the given owl:restriction";
      }
      op = jprop.siblings();
    ...
    if (!this.property || !restrtype) {
      throw "badly formed owl:restriction";
    }
    switch (restrtype) {
      case __.owl('cardinality'):
        this.restriction.minCard = this.restriction.maxCard = parseInt(op.text(), 10);
        break;
      case __.owl('maxCardinality'):
        this.restriction.maxCard = parseInt(op.text(), 10);
        break;
      case __.owl('minCardinality'):
        this.restriction.minCard = parseInt(op.text(), 10);
        break;
      case __.owl('hasValue'):
        var res = op.RDF_Resource();
        if (res) {
          this.target = res;
        }
        break;
    ...
    if (this.property.isObjectProperty) {
      if (this.isCardinalityRestriction && this.property.range) {
        this.target = this.property.range;
  ...
  jOWL.Ontology.Restriction.prototype = {
    ...
    merge: function (crit) {
      if (this.isCardinalityRestriction && crit.isValueRestriction) {
        this.target = crit.target;
        return true;
      } else if (this.isValueRestriction && crit.isCardinalityRestriction) {
        switch (crit.restrtype) {
          case __.owl('cardinality'):
            this.restriction.minCard = this.restriction.maxCard = crit.restriction.minCard;
            return true;
          case __.owl('minCardinality'):
            this.restriction.minCard = crit.restriction.minCard;
            return true;
          case __.owl('maxCardinality'):
            this.restriction.maxCard = crit.restriction.maxCard;
            return true;
        }
      }
      return false;
    ...
    equals: function (restr) {
      if (!restr.isRestriction) {
        return false;
      }
      if (this.property.URI == restr.property.URI) {
        if (this.target == 'anonymousOntologyObject') {
          return false;
        }//oneof lists etc unsupported right now
        if (this.target && this.target === restr.target) {
          return true;
        }
      }
      return false;
  ...
  jOWL.priv.Dt = function (options) {
    this.settings = $.extend({base: null, pattern: null, assert: function (b) {
        return true;
      }, match: function (a, b) {
        return true;
      }}, options);
  ...
  jOWL.priv.Dt.prototype = {
    sanitize: function (b) {
      if (this.settings.sanitize) {
        return this.settings.sanitize(b);
      }
      if (this.base && this.base.sanitize) {
        return this.base.sanitize(b);
      }
    },
    assert: function (b) {
      var v = this.sanitize(b);
      if (v !== undefined) {
        b = v;
      }
      if (this.base && !this.base.assert(b)) {
        return false;
      }
      if (this.settings.pattern && !this.settings.pattern.test(b)) {
        return false;
      }
    ...
    match: function (a, b) {
      ...
      if (this.base && !this.base.match(a, b)) {
        return false;
      }
  ...
  jOWL.Ontology.Datatype(__.xsd() + "integer", {sanitize: function (x) {
  ...
  jOWL.Ontology.Datatype(__.xsd() + "positiveInteger", {base: __.xsd() + "integer", assert: function (x) {
      return x > 0;
    }});
  ...
  jOWL.Ontology.Datatype(__.xsd() + "negativeInteger", {base: __.xsd() + "integer", assert: function (x) {
      return x < 0;
    }});
  jOWL.Ontology.Datatype(__.xsd() + "nonNegativeInteger", {base: __.xsd() + "integer", assert: function (x) {
      return x >= 0;
    }});
  jOWL.Ontology.Datatype(__.xsd() + "nonPositiveInteger", {base: __.xsd() + "integer", assert: function (x) {
      return x <= 0;
    }});
  ...
  jOWL.Ontology.DatatypeProperty = function (jnode) {
    ...
    if (this.type == __.owl("AnnotationProperty")) {
      this.range = __.xsd() + "string";
    }
  };
  ...
  jOWL.Ontology.DatatypeProperty.prototype = $.extend({}, jOWL.Ontology.Thing.prototype, jOWL.Ontology.Property.prototype, {
    ...
    assert: function (targetValue, value) {
      ...
      if (value === undefined) {
        return dt.assert(targetValue);
      } else {
        return dt.match(value, targetValue);
      }
    }
  });
  ...
  jOWL.Ontology.ObjectProperty = function (jnode) {
    ...
    jOWL.Xpath(__.rdf('type'), this.jnode).each(function () {
      if ($(this).RDF_Resource() == __.owl() + "TransitiveProperty") {
        self.isTransitive = true;
      }
    });
    if (this.jnode.get(0).nodeName == __.owl("TransitiveProperty")) {
      self.isTransitive = true;
    }
  };
  ...
  jOWL.Ontology.Intersection = function (jnode) {
    ...
    jOWL.Xpath(__.owl("Restriction"), jnode).each(function () {
      ...
      if (restr.isValueRestriction) {
        self._arr.push(restr);
      }
    });
    jOWL.Xpath(__.owl('Class'), jnode).each(function () {
      var uri = $(this).RDF_About();
      if (uri) {
        self._arr.push(jOWL(uri));
      }
    });
  };
  ...
  jOWL.Ontology.Intersection.prototype = {
    ...
    equals: function (isect) {
      if (!isect.isIntersection) {
        return false;
      }
      for (var i = 0; i < this._arr.length; i++) {
        var match = false;
        for (var j = 0; j < isect._arr.length; j++) {
          if (isect._arr[j].equals(this._arr[i])) {
            match = true;
          }
        }
        if (!match) {
  ...
  jOWL.Ontology.Class.prototype = $.extend({}, jOWL.Ontology.Thing.prototype, {
    ...
    individuals: function () {
      ...
      var q = new jOWL.SPARQL_DL("Type(?x, " + this.name + ")").execute({async: false, onComplete: function (r) {
          arr = r.jOWLArray("?x");
        }});
      return arr;
    },
    ...
    oneOf: function () {
      ...
      var oneOf = this.jnode.children().filter(function () {
        return this.tagName == __.owl("oneOf");
      });
      ...
      jOWL.index("property").each(function () {
        if (this.domain == that.name) {
          ...
          nodes.filter(function () {
            return (this.nodeName == __.owl('intersectionOf') || this.nodeName == __.rdfs('subClassOf'));
          }).each(function () {
            var cl = jOWL($(this.selectSingleNode('parent::' + __.owl('Class'))));
            if (!oChildren.contains(cl) && cl.name != that.name && cl.name !== undefined) {
              oChildren.push(cl);
            }
          });
        }
    ...
    setParents: function (parents) {
      jOWL.data(this.name, "parents", parents);
      return parents;
    },
    ...
    parents: function () {
      ...
      for (var i = 0; i < cls.length; i++) {
        jOWL.priv.Array.pushUnique(temp, cls[i]);
      }

      var restr = jOWL.Xpath.restrictions(this.jnode);
      restr.each(function () {
        if (this.property.domain && this.property.domain != self.name) {
          jOWL.priv.Array.pushUnique(temp, this.property.domain);
        }
      });
      ...
      } else if (oParents.length > 1) {
        oParents.filter(function () {
          return this.name != ('Thing');
        });
      } //Remove Thing reference if other parents exist
    ...
    hierarchy: function (addInverse) {
      ...
      function traverse(concept) {
        ...
        if (parents.length == 1 && parents.contains(__.owl() + 'Thing')) {
        ...
        } else
        {
          ...
          parents.filter(function () {
            return (!asso[this.URI]);
          }); //throw out redundancies
          parents.each(function () {
            var item = endNodes.flatindex.pushUnique(this);
            if (addInverse) {
              if (!item.invParents) {
                item.invParents = new jOWL.Ontology.Array();
              }
    ...
    descendants: function (level) {
      ...
      if (oDescendants && oDescendants.level >= level) {
        return oDescendants;
      }
    ...
    sourceof: function (property, target, options) {
      ...
      if (!crit) {
        ...
        arr.each(function (index, entry) {
          ...
          crit.each(function (item, i) {
            if (this.property.name == cr.property.name) {
              dupe = item;
            }
          });
          if (dupe) {
      ...
      crit.each(function () {
        ...
        if (!propertyMatch) {
          if (property.isArray) {
            propertyMatch = property.contains(this.property);
          } else {
            propertyMatch = (property.URI == this.property.URI);
          }
        }
        ...
        if (!targetMatch) {
          ...
          if (targ.isClass && options.ignoreClasses) {
            return;
          }
          ...
          if (!targetMatch && options.transitive && propertyMatch && this.property.isTransitive) {
            if (targ.isThing) {
              if (targ.sourceof(property, target).length) {
                targetMatch = true;
              }
            }
          }
          ...
          this.sourceof(property, target, options).each(function (parentsource) {
            ...
            results.filter(function () {
              ...
              if (restr.property.URI == parentsource.property.URI) {
                containsProperty = true;
                if (!options.ignoreGenerics) {
                  if (parentsource.target != restr.target) {
      ...
      if (arr.each) {
        arr.each(function () {
          if (ignoreUnique) {
            ...
            self.pushUnique(this);
          }
        });
      } else {
        self.items = self.items.concat(arr.items);
        this.length = self.items.length;
      }
      return this;
    },
    contains: function (o) {
  ...
  jOWL.options = {reason: true, locale: false, defaultlocale: 'en',
    ...
    onParseError: function (msg) {
      alert("jOWL parseError: " + msg);
    }, cacheProperties: true, niceClassLabels: true};
  jOWL.document = null;
  jOWL.namespace = null;
        ...
        if (i.IDs === null || wipe) {
          ...
          var rID = jOWL.Xpath("//*[@" + __.rdf("ID") + "]").each(function () {
            ...
            if (jowl) {
              ...
              if (jowl.isThing) {
                if (!i.T[jowl.Class]) {
                  i.T[jowl.Class] = new jOWL.Ontology.Array();
                }
          ...
          var rAbout = jOWL.Xpath("/" + __.rdf("RDF") + "/*[@" + __.rdf("about") + "]").each(function () {
            ...
            if (jowl.isClass || jowl.isProperty || jowl.isThing) {
              if (i.IDs[jowl.URI]) {
                jnode.children().appendTo(i.IDs[jowl.URI].jnode);
                return;
              }
              i.IDs[jowl.URI] = jowl;
              if (jowl.isThing) {
        ...
        if (i.I === null || wipe) {
          ...
          jOWL.Xpath("//" + __.owl("intersectionOf")).each(function () {
            ...
            if (dupe) {
              ...
              if (!i.I[isect.URI]) {
                i.I[isect.URI] = new jOWL.Ontology.Array();
              }
              temp.push(isect);
    ...
    if ($.browser.msie && location.toString().indexOf('file') === 0) { //IE won't load local xml files otherwise
      ...
      xml.onreadystatechange = function () {
        if (xml.readyState == "interactive") {
          ...
          callback(that.parse(xmldoc, options));
        }
      };
  ...
  jOWL.parse = function (doc, options) {
    ...
    if (typeof doc == 'string') {
      doc = jOWL.fromString(doc);
    }
    jOWL.document = doc;
    if ($.browser.msie) {
      if (doc.parseError.errorCode !== 0) {
        jOWL.options.onParseError(doc.parseError.reason);
        return false;
      }
    ...
    this.index('ID', true);
    if (jOWL.options.cacheProperties) {
      this.index('property', true);
    }
    if (jOWL.options.dictionary.create) {
      jOWL.index("dictionary");
    }
  ...
  jOWL.toString = function (xmlNode) {
    if (!xmlNode) {
      return jOWL.toString(jOWL.document);
    }
    if ($.browser.msie) {
      return xmlNode.xml;
    }
  ...
  jOWL.getResource = function (resource, options) {
    if (!jOWL.document) {
      throw "You must successfully load an ontology before you can find anything";
    }
    if (!resource) {
    ...
    if (typeof resource == 'string') {
      ...
      if (resource == 'Thing' || resource == __.owl() + 'Thing') {
        return jOWL.Thing;
      }
      if (opts.type == 'property' && jOWL.options.cacheProperties) {
        ...
        if (jOWL.isExternal(resource)) {
          ...
          return new jOWL.Ontology.Property(resource);
        }
      }
      var match = jOWL.index("ID")[resource];
      if (!match) { //try case insensitive
        for (caseIns in jOWL.index("ID")) {
          if (caseIns.toLowerCase() == resource.replace(/ /g, "").toLowerCase()) {
            match = jOWL.index("ID")[caseIns];
            break;
          }
        }
      }
  ...
  jOWL.type = function (node) {
    ...
    switch (xmlNode.nodeName) {
      case __.owl("Class") :
        return jOWL.Ontology.Class;
      case __.rdfs("Class") :
        return jOWL.Ontology.Class; //test
      case __.owl("Ontology") :
        return jOWL.Ontology;
      case __.owl("ObjectProperty") :
        return jOWL.Ontology.ObjectProperty;
      case __.owl("DatatypeProperty") :
        return jOWL.Ontology.DatatypeProperty;
      case __.owl("FunctionalProperty") :
        return jOWL.Ontology.Property;
      case __.rdf("Property") :
        return jOWL.Ontology.Property;
      case __.owl("InverseFunctionalProperty") :
        return jOWL.Ontology.ObjectProperty;
      case __.owl("TransitiveProperty") :
        return jOWL.Ontology.ObjectProperty;
      case __.owl("SymmetricProperty") :
        return jOWL.Ontology.ObjectProperty;
        //jOWL currently treats annotationproperties as string datatypeproperties.
      case __.owl("AnnotationProperty") :
        return jOWL.Ontology.DatatypeProperty;
      default :
        switch (xmlNode.namespaceURI) {
          case __.owl():
            if (xmlNode.nodeName == __.owl("Thing")) {
              return jOWL.Ontology.Individual;
            }
            return false;
          case __.rdf():
            return false;
  ...
  jOWL.create = function (namespace, name, document) {
    ...
    if ($.browser.msie) {
      el.node = doc.createNode(1, namespace(name), namespace());
    } else {
  ...
  jOWL.parseRDFa = function (fn, options) {
    ...
    function property(p, node) {
      var arr = [];
      $("[property=" + p + "]", node).each(function () {
        arr.push($(this).attr('content') || $(this).html());
      });
      if (node.attr('property') === p) {
        arr.push(node.attr('content') || node.html());
      }
      return arr;
    }
    ...
    function rel(p, node) {
      var arr = [];
      $("[rel=" + p + "]", node).each(function () {
        arr.push($(this).attr('resource'));
      });
      if (node.attr("rel") === p) {
        arr.push(node.attr('resource'));
      }
      return arr;
    }
    ...
    entries.each(function () {
      ...
      if (type == __.owl("Class")) {
        el = makeClass(node, jOWL.resolveURI(node.attr("about")));
      }
  ...
  jOWL.query = function (match, options) {
    ...
    if (options.filter == 'Class') {
      options.filter = __.owl("Class");
    }
    var that = this;
  ...
  jOWL.throttle = function (array, options) {
    ...
    (function () {
      ...
      if (items.length > 0) {
        if (options.async) {
          setTimeout(arguments.callee, options.timing);
        } else {
          arguments.callee();
        }
      } else {
  ...
  jOWL.SPARQL_DL_Result.prototype = {
    sort: function (param) {
      if (!param) {
        throw "parameter must be defined for sort function";
      }
    ...
    jOWLArray: function (param) {
      if (!param) {
        throw "parameter must be defined for jOWLArray function";
      }
      var arr = new jOWL.Ontology.Array();
      for (var i = 0; i < this.results.length; i++) {
        if (this.results[i][param]) {
          arr.pushUnique(this.results[i][param]);
        }
      }
      return arr;
    },
    ...
    filter: function (param, arr) {
      if (this.head[param] === undefined) {
        this.head[param] = arr;
      } else {
        var self = this;
        this.head[param].filter(function () {
          return (arr.contains(this));
        });
        arr.filter(function () {
          return (self.head[param].contains(this));
        });
      }
    },
  ...
  jOWL.SPARQL_DL_Query.prototype = {
    parse: function (syntax) {
      ...
      if (!entries) {
        this.error = "invalid abstract sparql-dl syntax";
        return;
      }
    ...
    sort: function (a, b) {
      var i;
      if (a[1].length == 1) {
        return (b[0] == 'PropertyValue') ? 1 : -1;
      }
      if (b[1].length == 1) {
        return (a[0] == 'PropertyValue') ? -1 : 1;
      }
      var avar = 0;
      for (i = 0; i < a[1].length; i++) {
        if (typeof a[1][i] == 'string') {
          avar++;
        }
      }
      var bvar = 0;
      for (i = 0; i < a[1].length; i++) {
        if (typeof b[1][i] == 'string') {
          bvar++;
        }
      }
      if (avar != bvar) {
  ...
  _Binding.prototype = {
    bind: function (key, value) {
      ...
      if (!this.arr.mappings[key]) {
        this.arr.mappings[key] = new jOWL.Ontology.Array();
      }
  ...
  function SPARQL_DL_Array(keys) {
    ...
    if (keys) {
      for (var i = 0; i < keys.length; i++) {
        if (keys[i]) {
          this.mappings[keys[i]] = new jOWL.Ontology.Array();
        }
      }
    }
  }
  ...
  SPARQL_DL_Array.prototype = {
    ...
    keyCentric: function (keyX) {
      ...
      for (var i = this.arr.length - 1; i >= 0; i--) {
        if (this.arr[i][keyX]) {
          if (!arr[this.arr[i][keyX].URI]) {
            arr[this.arr[i][keyX].URI] = [];
          }
  ...
  jOWL.SPARQL_DL = function (syntax, parameters, options) {
    if (!(this instanceof arguments.callee)) {
      return new jOWL.SPARQL_DL(syntax, parameters, options);
    }
    var self = this;
  ...
  jOWL.SPARQL_DL.prototype = {
    ...
    execute: function (options) {
      ...
      if (this.query.error) {
        return this.error(this.query.error);
      }

      var resultobj = this.result;
      var i = 0;
      var loopoptions = $.extend({}, this.options);
      loopoptions.onComplete = function (results) {
        i++;
        resultobj = results;
        loop(i);
      };
      ...
      function loop(i) {
        if (i < self.query.length) {
          ...
          for (var j = 0; j < resultobj.results.length; j++) { //Convert Literals into strings
            ...
            for (x in b) {
              if (b[x] instanceof jOWL.Literal) {
                b[x] = b[x].name;
              }
            }
          }
    ...
    process: function (entry, resultobj, options) {
      ...
      if (!sizes[q]) {
        return self.error("'" + q + "' queries are not implemented");
      }
      if (sizes[q].length != entry[1].length) {
        return self.error("invalid SPARQL-DL " + q + " specifications, " + sizes[q].length + " parameters required");
      }
      for (var i = 0; i < entry[1].length; i++) {
        var v = sizes[q][i];
        if (v) {
          var m = entry[1][i];
          if (typeof m != 'string' && m.type != v) {
            return self.error("Parameter " + i + " in SPARQL-DL Query for " + q + " must be of the type: " + v);
          }
        }
      }
      if (q == "DirectType") {
        options.childDepth = 0;
        return self.fn.Type.call(self, entry[1], resultobj, options);
      } else if (q == "DirectSubClassOf") {
        options.childDepth = 1;
        return self.fn.SubClassOf.call(self, entry[1], resultobj, options);
      }
    ...
    fn: {
      ...
      "Type": function (syntax, resultobj, options) {
        ...
        if (atom.source.isURI() && atom.target.isURI()) {//assert
          return jOWL.SPARQL_DL.priv.assert(resultobj, function () {
            ...
            if (cl.URI == atom.target.value.URI) {
              return true;
            }
          ...
          atom.source.getURIs().each(function () {
            var b;
            if (addTarget) {
              b = results.push(atom.target.value, this.owlClass());
            }
            if (addSource) {
              if (addTarget) {
                b.bind(atom.source.value, this);
              } else {
                results.push(atom.source.value, this);
              }
            }
          ...
          classlist.each(function () { //expand list of classes, not very fast!
            ...
            if (oneOf.length) {
              ...
              this.descendants(options.childDepth).each(function () { //this is the slower call
      ...
      "Class": function (syntax, resultobj, options) {
        console.log('cl');
  ...
  jOWL.SPARQL_DL.priv = {
    ...
    PropertyValuegetSourceInfo: function (jSource, property, target, resultobj, options) {
      ...
      jSource.each(function () {
        ...
        restrictions.each(function () {
          ...
          if (options.filterSource) {
            ...
            if (!options.filterProperty && !options.filterTarget) {
              results.add(binding);
              return false;
            }
          }
      ...
      if (options.filterSource) {
        resultobj.filter(options.filterSource, results.get(options.filterSource));
      }
      if (options.filterProperty) {
        resultobj.filter(options.filterProperty, results.get(options.filterProperty));
      }
      if (options.filterTarget) {
        resultobj.filter(options.filterTarget, results.get(options.filterTarget));
      }
      resultobj.bind(results.getArray());
    },
    ...
    IDQuery: function (parameter, classID, resultobj, options) {
      ...
      for (x in jOWL.index("ID")) {
        ...
        if (jOWL.SPARQL_DL.priv.hasClassID(match, classID)) {
          results.push(parameter, match);
        }
      }
    ...
    PropertyQuery: function (parameter, index, className, resultobj, options) {
      ...
      var tr = new jOWL.throttle(index, $.extend({}, options, {
        modify: function (result) {
          ...
          if (jOWL.SPARQL_DL.priv.hasClassID(result, className)) {
  ...
  jOWL.SPARQL_DL.Atom = function (syntax, store) {
    ...
    if (typeof syntax == 'string') {
      if (syntax.indexOf('?') === 0) {
        this.type = this.VAR;
        if (store && store[syntax]) {
          this.mappings = store[syntax];
        }
      } else {
  ...
  jOWL.SPARQL_DL.Atom.prototype = {
    ...
    getURIs: function () {
      if (this.isURI()) {
        return new jOWL.Ontology.Array([this.value]);
      }
  ...
  jOWL.permalink = function (entry) {
    if (!entry) {
      ...
      if (param.owlClass) {
        return jOWL(unescape(param.owlClass));
      }
    } else {
      if (!entry.URI) {
        return false;
  ...
  jOWL.Manchester = function (owlElement) {
    ...
    if (owlElement.isClass) {
      var oneOf = owlElement.oneOf().map(function () {
        return this.label();
      });
      if (oneOf.length) {
        syntax.push("{ " + oneOf.join(", ") + " }");
      }
    }
    return syntax.join(", ");
  };
...
String.prototype.searchMatch = function (matchstring, exact) {
  if (this.search(new RegExp(matchstring, "i")) > -1) {
    return 1;
  } //contained within
  var c = 0;
  var arr = matchstring.match(new RegExp("\\w+", "ig"));
  for (var i = 0; i < arr.length; i++) {
    if (this.search(arr[i]) > -1) {
      c++;
    }
  }
  if (c == arr.length) {
